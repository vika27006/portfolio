...
В проекте спроектирована реляционная база данных для интернет-магазина спортивных товаров. Созданы пять таблиц с первичными и внешними ключами. Добавлены CHECK-ограничения для цен, остатков и статусов заказов. Наполнены тестовые данные для демонстрации работы схемы. Технологии: PostgreSQL.
